...
<div style="max-width: 800px; margin: 2rem auto; background: white; border-radius: 20px; padding: 2rem;">
    ...
    <div style="text-align: center;">
        ...
        <!-- Canva on es crea el primer grafic de tipus quesito -->
        ...
        <!-- Canvas on es crea el segon grafic de tipus quesito -->
...
// Creació del gràfic de tècnics amb chart.js
...
// Creació del gràfic de departaments amb chart.js
